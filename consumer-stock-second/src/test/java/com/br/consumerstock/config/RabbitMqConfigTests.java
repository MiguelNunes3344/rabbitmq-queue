package com.br.consumerstock.config;
...
import com.br.consumerstock.consumer.config.RabbitMqConfig;
import com.br.consumerstock.exception.ErrorHandlerTreatment;
